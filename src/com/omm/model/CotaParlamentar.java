...
@Entity // indicar que essa classe é uma entidade no banco de dados
@Table(name = "Ceap") // especificar tabela do banco 
public class CotaParlamentar {
	...
	@Column //possui o mesmo nome na tabela do banco
	double valorJaneiro;
